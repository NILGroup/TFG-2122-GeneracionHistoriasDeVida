...
class Model:
    ...
    def generateText(self, encode_text, do_sample = False, num_beams = 5, no_repeat_ngram_size = 2,
     min_length = 0, max_length = 500, top_k = 50, top_p = 0.95, temperature = 1.0, penalty = 1.0, num_return_sequences = 3, early_stopping=True):
